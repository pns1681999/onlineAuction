...
module.exports={
    ...
    pageAutionByBidder: (bidderId, offset) => db.load(`SELECT * FROM (SELECT a.IdSanPham,b.TenSanPham,b.GiaHienTai,b.NgayHetHan, b.IdNguoiThang FROM daugia a, sanpham b where a.IdNguoiDung=${bidderId} and a.IdSanPham=b.IdSanPham group by a.IdSanPham
